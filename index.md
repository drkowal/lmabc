...
reference category (this is equivalent to using $L - 1$ dummy variables
to encode a categorical variable with $L$ categories). For illustration,
...
and
[`getFullDesign()`](https://drkowal.github.io/lmabc/reference/getFullDesign.md)
methods in this package. Please email the package maintainer with any
issues or questions.
