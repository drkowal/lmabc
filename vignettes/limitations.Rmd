...
The standard implementation of `lm` can handle data passed as vectors, thus rendering the `data` argument optional. `lmabc` requires the columns referenced in the formula to be passed to `lmabc` as a data frame.
